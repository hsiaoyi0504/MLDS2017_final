...
def main():
    ...
    if args.restore or (args.op == "test"):
        ...
        if CONFIG == 1:
            ...
            model.add(Bidirectional(GRU(128, return_sequences=True, activation='tanh', recurrent_dropout=dropout_prob, dropout=dropout_prob)))
            model.add(Bidirectional(GRU(128, return_sequences=True, activation='tanh', recurrent_dropout=dropout_prob, dropout=dropout_prob)))
            model.add(Bidirectional(GRU(128, activation='tanh', recurrent_dropout=dropout_prob, dropout=dropout_prob)))
